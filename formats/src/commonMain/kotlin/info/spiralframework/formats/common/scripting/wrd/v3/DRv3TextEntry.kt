...
public data class DRv3TextEntry(val text: WordScriptValue.Text) : WrdEntry {
    public constructor(opcode: Int, arguments: Array<WordScriptValue>) : this(arguments[0] as WordScriptValue.Text)
