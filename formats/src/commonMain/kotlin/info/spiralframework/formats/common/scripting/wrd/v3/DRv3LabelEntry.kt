...
public data class DRv3LabelEntry(val label: WordScriptValue.Label) : WrdEntry {
    public constructor(opcode: Int, rawArguments: Array<WordScriptValue>): this(rawArguments[0] as WordScriptValue.Label)
