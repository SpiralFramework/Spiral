...
class GMOMeshFacesChunk(chunkType: Int, chunkHeaderSize: Int, chunkSize: Long, header: IntArray, val arIndex: Int, val unknown: Int, val primType: Long, val faces: List<IntArray>):
        GMOModelChunk(chunkType, chunkHeaderSize, chunkSize, header)