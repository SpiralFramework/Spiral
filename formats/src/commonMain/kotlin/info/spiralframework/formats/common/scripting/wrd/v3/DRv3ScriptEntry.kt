...
public data class DRv3ScriptEntry(val scriptName: WordScriptValue.Parameter, val label: WordScriptValue.Label): WrdEntry {
    public constructor(opcode: Int, arguments: Array<WordScriptValue>): this(arguments[0] as WordScriptValue.Parameter, arguments[1] as WordScriptValue.Label)
