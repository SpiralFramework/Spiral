...
data class DRv3SpeakerEntry(val speaker: WordScriptValue.Parameter): WrdEntry {
    constructor(opcode: Int, arguments: Array<WordScriptValue>): this(arguments[0] as WordScriptValue.Parameter)
