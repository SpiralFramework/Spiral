...
data class ScreenFlashEntry(val red: Int, val green: Int, val blue: Int, val fadeInDuration: Int, val holdDuration: Int, val fadeOutDuration: Int, val opacity: Int): LinEntry {
