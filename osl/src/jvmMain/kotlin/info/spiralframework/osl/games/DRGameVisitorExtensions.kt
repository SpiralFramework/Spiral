...
public fun DRGameVisitor?.handleCltCode(builder: StringBuilder, code: String): Boolean =
        this?.handleCltCode(builder, code) == true

public fun DRGameVisitor?.clearCltCode(builder: StringBuilder): Boolean =
 ...
 */
public fun DRGameVisitor?.entryForName(name: String, arguments: IntArray): OSLUnion =
 ...
 * Returns OSLUnion.UndefinedType if this is null
 */
public fun DRGameVisitor?.entryForOpCode(opCode: Int, arguments: IntArray): OSLUnion =
