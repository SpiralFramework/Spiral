...
//            opcode(0x07, argumentCount = -1, names = null)
        ...
        opcode(0x0F, argumentCount = 3, name = "Set_Title")

        opcode(0x10, argumentCount = 3, name = "Set_Report_Info")
...
//            opcode(0x24, argumentCount = -1, names = null)
        ...
        opcode(0x26, argumentCount = 3, name = "Set_Flag")
...
//            opcode(0x28, argumentCount = -1, names = null, entryConstructor = ::UnknownEntry)
        ...
        opcode(0x2A, argumentCount = 2, names = arrayOf("Mark Label", "Set_Label"))
...
//            opcode(0x31, argumentCount = -1, names = null, entryConstructor = ::UnknownEntry)
        ...
        opcode(0x33, argumentCount = 4, name = "Set_Game_Parameter")
