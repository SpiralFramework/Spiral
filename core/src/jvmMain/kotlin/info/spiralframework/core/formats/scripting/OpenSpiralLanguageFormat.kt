...
public object OpenSpiralLanguageFormat : ReadableSpiralFormat<OpenSpiralBitcodeWrapper>, WritableSpiralFormat<Unit> {
    ...
    override suspend fun identify(context: SpiralContext, readContext: SpiralProperties?, source: DataSource<*>): SpiralFormatOptionalResult<OpenSpiralBitcodeWrapper> =
    ...
    override suspend fun read(context: SpiralContext, readContext: SpiralProperties?, source: DataSource<*>): SpiralFormatReturnResult<OpenSpiralBitcodeWrapper> =
        ...
        when (data) {
            is LinScript -> {
                LinTranspiler(
                    ...
                    ?: return context.localisedSpiralMissingProperty(DrGame.LinScriptable, "")
                ).transpile(flow)
