...
public data class SemanticVersion(val major: Int, val minor: Int, val patch: Int) : Comparable<SemanticVersion> {
    /**
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val otherVersion = (other as? SemanticVersion) ?: return false
