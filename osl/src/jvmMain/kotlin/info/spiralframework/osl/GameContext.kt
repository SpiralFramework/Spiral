...
sealed class GameContext {
    ...
    object DR1GameContext: GameContext.HopesPeakGameContext(DR1)
    object DR2GameContext: GameContext.HopesPeakGameContext(DR2)
    object UDGGameContext: GameContext.HopesPeakGameContext(UDG)
    object UnknownHopesPeakGameContext: GameContext.HopesPeakGameContext(UnknownHopesPeakGame)
    open class CatchAllHopesPeakGameContext(game: HopesPeakDRGame): GameContext.HopesPeakGameContext(game)

    abstract class HopesPeakTrialContext(override val game: HopesPeakKillingGame): GameContext.HopesPeakGameContext(game) {
        companion object {
    ...
    abstract class NonstopDebateMinigameContext(game: HopesPeakKillingGame): GameContext.HopesPeakMinigameContext(game) {
        companion object {
    ...
    object V3GameContextObject: GameContext.V3GameContext(V3)
    open class CatchAllV3GameContext(game: V3): GameContext.V3GameContext(game)
