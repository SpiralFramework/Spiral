                ...
                OneOrMore(
                        ...
                        FirstOf(
                                Sequence(
                                        ...
                                        Action<Any> { operationVar.set(info.spiralframework.osl.EnumLinFlagCheck.values().first { enum -> match() in enum.names }.flag) },
                                        OptionalInlineWhitespace()
                                ),
                                Action<Any> { operationVar.set(info.spiralframework.osl.EnumLinFlagCheck.EQUALS.flag) }
                        ),
                        FlagValue(),
