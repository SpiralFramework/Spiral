...
object DRVitaCompression : ICompression {
    ...
    override fun isCompressed(context: SpiralContext, dataSource: () -> InputStream): Boolean =
                ...
                dataSource.use { stream ->
                    ...
                    while (i < compressedSize) {
                        ...
                        if (bit1) {
                            ...
                            error("formats.dr_vita.compression.invalid_bit_combination", bit1, bit2, bit3)
                    }
