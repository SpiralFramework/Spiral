...
object CpkFormat: ReadableSpiralFormat<CPK>, WritableSpiralFormat {
     ...
     */
    override fun read(context: SpiralContext,readContext: FormatReadContext?, source: DataSource): FormatResult<CPK> {
        val cpk = CPK(context, source) ?: return FormatResult.Fail(this, 1.0)
     ...
     */
    override fun supportsWriting(context: SpiralContext, data: Any): Boolean = data is AWB || data is WAD || data is CPK || data is SPC || data is Pak || data is ZipFile
    ...
    override fun write(context: SpiralContext, writeContext: FormatWriteContext?, data: Any, stream: OutputStream): FormatWriteResponse {
        ...
        customCpk.compile(context, stream)
